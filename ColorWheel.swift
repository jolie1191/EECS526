...
//
//  Imported by Su Yan on 12/5/15
//  Free to use under GNU GENERAL PUBLIC LICENSE V3, https://gnu.org/licenses/gpl.html
//  Source: https://github.com/mingsai/ColorWheel
//
...
class ColorWheel: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        let radius = CGFloat ( min(bounds.size.width, bounds.size.height) / 2.0 ) * 0.99
